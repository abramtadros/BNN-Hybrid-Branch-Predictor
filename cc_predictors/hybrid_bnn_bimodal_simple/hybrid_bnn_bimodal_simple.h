#ifndef BRANCH_HYBRID_BNN_BIMODAL_H
#define BRANCH_HYBRID_BNN_BIMODAL_H
...
class hybrid_bnn_bimodal_simple : public champsim::modules::branch_predictor
{
  ...
  static constexpr std::size_t BIMODAL_PRIME = 16381;
  ...
  bnn_type bnn_predictor{24, 12, 0.20, 1e-3, 8, 32, 2048, 8, 128, 0.02, 19};
